...
"}")
        ...
        self.statsContainer.setMinimumSize(QSize(1300, 1))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Storage Usage", None));
